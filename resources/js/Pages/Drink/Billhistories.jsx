        ...
        <AuthenticatedLayout>
            <div className="container mx-auto p-4 max-w-4xl">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-semibold text-gray-900">ประวัติการสั่งซื้อ</h1>
                    ...
                    <div className="space-y-4">
                        {filteredBills.length === 0 ? (
                            <div className="text-center p-8 bg-gray-100 rounded-lg">
                                <p className="text-gray-800">ไม่พบรายการที่ค้นหา</p>
                            </div>
                        ) : (
                                ...
                                >
                                    ...
                                    {bill.items && bill.items.length > 0 ? (
                                        ...
                                        <div className="text-center p-4 bg-gray-200 rounded-lg">
                                            <p className="text-gray-800">ไม่มีรายการในบิลนี้</p>
                                        </div>
                                    )}
                                </div>
                            ))
